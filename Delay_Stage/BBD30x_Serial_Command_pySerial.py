...
"""
Hi X-WaveS team, this file was pulled and modified from Thorlabs Github 
repo at: https://github.com/Thorlabs/Motion_Control_Examples/tree/main/Python/Benchtop/BBDXXX

There you'll find the steps to configure the PC to run it, this is in essence how you
configure the PC to communicate through serial with the BBD301 delay stage driver
